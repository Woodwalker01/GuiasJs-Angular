      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
         ...
         <Nav.Link><Link to="/" style={{color:"white", textDecoration:"none"}}>Sucursales</Link></Nav.Link>
            <Nav.Link><Link to="contacto" style={{color:"white", textDecoration:"none"}}>Ventas Menores</Link></Nav.Link>
            <Nav.Link><Link to="help" style={{color:"white", textDecoration:"none"}}>Ventas Mayores</Link></Nav.Link>
            <Nav.Link><Link to="" style={{color:"white", textDecoration:"none"}}>Informes</Link></Nav.Link>
          </Nav>
          <Nav>

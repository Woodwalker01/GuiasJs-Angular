...
function init() {
    ...
    var op1 = prompt('Introduzca los metros a convertir:','');
    ...
    resultado.innerHTML = "<p class=\"letterpress\">" + op1 + " *  3.28084 = " + (parseFloat(op1)* 3.28084) + "</p>\n";
    }
    break;
    case 1:
    opciones[i].onclick = function(){
    resultado.innerHTML = "<p class=\"letterpress\">" + op1 + "* 39.3701= " + (parseFloat(op1)*39.3701) + "</p>\n";
    }
    break;
    case 2:
    opciones[i].onclick = function(){
    resultado.innerHTML = "<p class=\"letterpress\">" + op1 + " *  1.09361 = "  + (parseFloat(op1) * 1.09361) + "</p>\n";
    }
    break;
    case 3:
    opciones[i].onclick = function(){
